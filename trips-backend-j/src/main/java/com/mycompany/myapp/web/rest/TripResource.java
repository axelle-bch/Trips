    ...
    public ResponseEntity<Trip> partialUpdateTrip(@PathVariable(value = "id", required = false) final Long id, @RequestBody Trip trip)
        ...
        Optional<Trip> result = tripRepository
            ...
            .map(existingTrip -> {
                ...
                if (trip.getMinTravelersNumber() != null) {
                    existingTrip.setMinTravelersNumber(trip.getMinTravelersNumber());
                }
                if (trip.getMaxTravelersNumber() != null) {
                    existingTrip.setMaxTravelersNumber(trip.getMaxTravelersNumber());
                }
