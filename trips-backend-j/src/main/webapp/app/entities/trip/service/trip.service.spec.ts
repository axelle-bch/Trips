...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../trip.test-samples';

import { TripService } from './trip.service';

const requireRestSample: ITrip = {
...
describe('Trip Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Trip', () => {
      ...
      const trip = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(trip).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Trip', () => {
      const trip = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(trip).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addTripToCollectionIfMissing', () => {
      it('should add a Trip to an empty array', () => {
        const trip: ITrip = sampleWithRequiredData;
      ...
      it("should add a Trip to an array that doesn't contain it", () => {
        const trip: ITrip = sampleWithRequiredData;
        const tripCollection: ITrip[] = [sampleWithPartialData];
        expectedResult = service.addTripToCollectionIfMissing(tripCollection, trip);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(trip);
      });
      ...
      it('should add only unique Trip to an array', () => {
        const tripArray: ITrip[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const tripCollection: ITrip[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const trip: ITrip = sampleWithRequiredData;
        const trip2: ITrip = sampleWithPartialData;
    ...
    describe('compareTrip', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareTrip(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareTrip(entity1, entity2);
        const compareResult2 = service.compareTrip(entity2, entity1);
